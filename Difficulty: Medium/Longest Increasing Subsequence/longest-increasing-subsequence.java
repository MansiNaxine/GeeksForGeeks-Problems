class Solution {
    static int lis(int arr[]) {
        ...
        //MEMOIZATION
        int[][] dp = new int[n][n];
        return memoRecursion(arr, n, 0, -1, dp);
        
    }
    
    public static int memoRecursion(int[] nums, int n, int index, int prev, int[][] dp) {
        //base case
        if(index == n) return 0;
    ...
    public static int recursion(int[] nums, int n, int index, int prev) {
        //base case
        if(index == n) return 0;
